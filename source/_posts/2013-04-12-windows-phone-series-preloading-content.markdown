...
![preloaded content Visual studio]({{ site.images_root}}/preloaded_content_Visual_studio.png)
...
![preloaded content explorer]({{ site.images_root}}/preloaded_content_explorer.png)
...
![preloaded content visual studio refresh]({{ site.images_root}}/preloaded_content_vs_refresh.png)
