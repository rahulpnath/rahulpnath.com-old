...
Tools are an indispensable part of our daily life and we all have our own likes and dislikes for them. Here are a list that I prefer to use(almost daily). Most of them influenced from the [greater list](http://www.hanselman.com/tools). 
...
- <strikeout>Resharper</strikeout>: I had been using this on and off and realized that mostly I was using only the 'navigate to' feature and decided on to start using the in built features of Visual Studio. Mark Seemann has quite an interesting [article](http://blog.ploeh.dk/2013/02/04/BewareofProductivityTools/) on this and I couldn't agree any more. Resharper is also changing their licensing model going from a one time fee to a monthly fee, which I don't personally prefer especially for a tool like R#. 