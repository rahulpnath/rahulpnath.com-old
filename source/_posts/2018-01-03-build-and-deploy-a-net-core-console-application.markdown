...
<img src="{{site.images_root}}/net_core_teamcity_build_steps.png" alt="Build Steps to build .Net Core">
...
<img src="{{site.images_root}}/net_core_octopus_deploy_process.png" alt="Octopus Deploy Process Steps">
